...
class Institution(object):
    ...
    def __init__(self, language_iso_code=None, favicon=None, country_iso_code=None, is_added_by_user=None, priority=None, primary_language_iso_code=None, base_url=None, login_url=None, provider_id=None, name=None, logo=None, id=None, last_modified=None, _configuration=None):  # noqa: E501
