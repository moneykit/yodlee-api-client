...
class AddedProviderAccount(object):
    ...
    def __init__(self, last_updated=None, aggregation_source=None, oauth_migration_status=None, provider_id=None, request_id=None, is_manual=None, id=None, dataset=None, status=None, _configuration=None):  # noqa: E501
