...
class VerifiedAccount(object):
    ...
    def __init__(self, full_account_number=None, account_type=None, provider_account_id=None, holder=None, id=None, account_number=None, bank_transfer_code=None, provider_name=None, _configuration=None):  # noqa: E501
