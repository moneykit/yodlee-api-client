...
class CreateConsent(object):
    ...
    def __init__(self, data_access_frequency=None, title_body=None, consent_id=None, provider_id=None, consent_status=None, scope=None, title=None, expiration_date=None, _configuration=None):  # noqa: E501
    ...
    def consent_status(self, consent_status):
        ...
        allowed_values = ["ACTIVE", "CONSENT_GENERATED", "CONSENT_ACCEPTED", "CONSENT_AUTHORIZED", "CONSENT_MISMATCH", "PENDING", "EXPIRED", "REVOKED"]  # noqa: E501
        if (self._configuration.client_side_validation and
