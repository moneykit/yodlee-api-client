...
class VerificationStatus(object):
    ...
    def __init__(self, account_id=None, reason=None, verification_status=None, provider_account_id=None, verification_type=None, account=None, remaining_attempts=None, verification_date=None, verification_id=None, _configuration=None):  # noqa: E501
    ...
    def verification_type(self, verification_type):
        ...
        if (self._configuration.client_side_validation and
                verification_type not in allowed_values):
            raise ValueError(
