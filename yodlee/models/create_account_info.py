...
class CreateAccountInfo(object):
    ...
    def __init__(self, include_in_net_worth=None, address=None, account_name=None, account_type=None, due_date=None, memo=None, home_value=None, account_number=None, frequency=None, amount_due=None, balance=None, nickname=None, valuation_type=None, local_vars_configuration=None):  # noqa: E501
        """CreateAccountInfo - a model defined in OpenAPI"""  # noqa: E501
    ...
    def account_type(self, account_type):
        ...
        if (self.local_vars_configuration.client_side_validation and
                account_type is not None and len(account_type) > 2147483647):
