...
class UpdatedProviderAccount(object):
    ...
    def __init__(self, last_updated=None, login_form=None, created_date=None, aggregation_source=None, oauth_migration_status=None, provider_id=None, request_id=None, is_manual=None, id=None, dataset=None, status=None, local_vars_configuration=None):  # noqa: E501
        """UpdatedProviderAccount - a model defined in OpenAPI"""  # noqa: E501
