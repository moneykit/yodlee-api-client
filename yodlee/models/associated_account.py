...
class AssociatedAccount(object):
    ...
    def __init__(self, last_updated=None, balance=None, account_name=None, provider_id=None, account_type=None, current_balance=None, provider_account_id=None, container=None, id=None, account_number=None, provider_name=None, available_balance=None, _configuration=None):  # noqa: E501
