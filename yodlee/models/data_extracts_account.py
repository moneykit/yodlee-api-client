...
class DataExtractsAccount(object):
    ...
    def home_insurance_type(self, home_insurance_type):
        ...
        if (self._configuration.client_side_validation and
                home_insurance_type not in allowed_values):
            raise ValueError(
    ...
    def valuation_type(self, valuation_type):
        ...
        if (self._configuration.client_side_validation and
                valuation_type not in allowed_values):
            raise ValueError(
    ...
    def interest_rate_type(self, interest_rate_type):
        ...
        if (self._configuration.client_side_validation and
                interest_rate_type not in allowed_values):
            raise ValueError(
    ...
    def repayment_plan_type(self, repayment_plan_type):
        ...
        if (self._configuration.client_side_validation and
                repayment_plan_type not in allowed_values):
            raise ValueError(
    ...
    def life_insurance_type(self, life_insurance_type):
        ...
        if (self._configuration.client_side_validation and
                life_insurance_type not in allowed_values):
            raise ValueError(
    ...
    def minimum_amount_due(self):
        ...
        The minimum amount due is the lowest amount of money that a consumer is required to pay each month.<br><br><b>Aggregated / Manual</b>: Aggregated<br><b>Applicable containers</b>: creditCard, insurance, loan<br><b>Endpoints</b>:<ul><li>GET accounts</li><li>GET accounts/{accountId}</li><li>GET dataExtracts/userData</li></ul>  # noqa: E501
    ...
    def source_account_status(self, source_account_status):
        ...
        if (self._configuration.client_side_validation and
                source_account_status not in allowed_values):
            raise ValueError(
    ...
    def policy_status(self, policy_status):
        ...
        if (self._configuration.client_side_validation and
                policy_status not in allowed_values):
            raise ValueError(
    ...
    def last_payment_amount(self):
        ...
        Last/Previous payment amount on the account.  Portion of the principal and interest paid on previous month or period to satisfy a loan.<br><b>Additional Details:</b> If the payment is already done for the current billing cycle, then the field indicates the payment of the current billing cycle. If payment is yet to be done for the current billing cycle, then the field indicates the payment that was made for any of the previous billing cycles.<br><br><b>Aggregated / Manual</b>: Aggregated<br><b>Applicable containers</b>: creditCard, loan, insurance<br><b>Endpoints</b>:<ul><li>GET accounts</li><li>GET accounts/{accountId}</li><li>GET dataExtracts/userData</li></ul>  # noqa: E501
    ...
    def user_classification(self, user_classification):
        ...
        if (self._configuration.client_side_validation and
                user_classification not in allowed_values):
            raise ValueError(
