...
class DataExtractsAccount(object):
    ...
    def __init__(self, available_cash=None, include_in_net_worth=None, money_market_balance=None, enrollment_date=None, estimated_date=None, memo=None, guarantor=None, interest_paid_last_year=None, last_updated=None, balance=None, home_insurance_type=None, id=None, cash=None, total_credit_line=None, provider_name=None, valuation_type=None, margin_balance=None, apr=None, available_credit=None, current_balance=None, is_manual=None, escrow_balance=None, next_level=None, classification=None, loan_payoff_amount=None, interest_rate_type=None, loan_pay_by_date=None, face_amount=None, policy_from_date=None, premium_payment_term=None, policy_term=None, repayment_plan_type=None, aggregated_account_type=None, available_balance=None, account_status=None, life_insurance_type=None, premium=None, aggregation_source=None, is_deleted=None, over_draft_limit=None, nickname=None, term=None, interest_rate=None, death_benefit=None, address=None, cash_value=None, _401k_loan=None, home_value=None, account_number=None, created_date=None, interest_paid_ytd=None, provider_account_id=None, is_selected_for_aggregation=None, collateral=None, dataset=None, running_balance=None, source_id=None, due_date=None, frequency=None, maturity_amount=None, associated_provider_account_id=None, is_asset=None, principal_balance=None, total_cash_limit=None, maturity_date=None, minimum_amount_due=None, annual_percentage_yield=None, account_type=None, origination_date=None, total_vested_balance=None, reward_balance=None, source_account_status=None, linked_account_ids=None, derived_apr=None, policy_effective_date=None, total_unvested_balance=None, annuity_balance=None, account_name=None, total_credit_limit=None, policy_status=None, short_balance=None, lender=None, last_employee_contribution_amount=None, provider_id=None, last_payment_date=None, primary_reward_unit=None, last_payment_amount=None, remaining_balance=None, user_classification=None, bank_transfer_code=None, expiration_date=None, coverage=None, cash_apr=None, oauth_migration_status=None, displayed_name=None, source_provider_account_id=None, amount_due=None, current_level=None, original_loan_amount=None, policy_to_date=None, loan_payoff_details=None, container=None, last_employee_contribution_date=None, last_payment=None, recurring_payment=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._is_selected_for_aggregation = None
        ...
        self._source_provider_account_id = None
        ...
        if is_selected_for_aggregation is not None:
            self.is_selected_for_aggregation = is_selected_for_aggregation
        ...
        if source_provider_account_id is not None:
            self.source_provider_account_id = source_provider_account_id
    ...
    def aggregated_account_type(self):
        """Gets the aggregated_account_type of this DataExtractsAccount.  # noqa: E501

        The type of account that is aggregated.  # noqa: E501

        :return: The aggregated_account_type of this DataExtractsAccount.  # noqa: E501
        :rtype: str
        """
    ...
    def aggregated_account_type(self, aggregated_account_type):
        """Sets the aggregated_account_type of this DataExtractsAccount.

        The type of account that is aggregated.  # noqa: E501

        :param aggregated_account_type: The aggregated_account_type of this DataExtractsAccount.  # noqa: E501
    ...
    @property
    def is_selected_for_aggregation(self):
        """Gets the is_selected_for_aggregation of this DataExtractsAccount.  # noqa: E501

        Indicates if the account is selected by user for aggregation.<br><b>Applicable containers</b>: All Containers<br><b>Aggregated / Manual</b>: Both <br><b>Endpoints</b>:<br><ul><li>GET dataExtracts/userData</li></ul>  # noqa: E501

        :return: The is_selected_for_aggregation of this DataExtractsAccount.  # noqa: E501
        :rtype: bool
        """
        return self._is_selected_for_aggregation

    @is_selected_for_aggregation.setter
    def is_selected_for_aggregation(self, is_selected_for_aggregation):
        """Sets the is_selected_for_aggregation of this DataExtractsAccount.

        Indicates if the account is selected by user for aggregation.<br><b>Applicable containers</b>: All Containers<br><b>Aggregated / Manual</b>: Both <br><b>Endpoints</b>:<br><ul><li>GET dataExtracts/userData</li></ul>  # noqa: E501

        :param is_selected_for_aggregation: The is_selected_for_aggregation of this DataExtractsAccount.  # noqa: E501
        :type is_selected_for_aggregation: bool
        """

        self._is_selected_for_aggregation = is_selected_for_aggregation
    ...
    def linked_account_ids(self):
        """Gets the linked_account_ids of this DataExtractsAccount.  # noqa: E501
        ...
        :return: The linked_account_ids of this DataExtractsAccount.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def linked_account_ids(self, linked_account_ids):
        """Sets the linked_account_ids of this DataExtractsAccount.

        List of Loan accountId(s) to which the real-estate account is linked<br><br><b>Aggregated / Manual</b>: Both <br><b>Applicable containers</b>: realEstate<br><b>Endpoints</b>:<ul><li>GET accounts</li><li>GET accounts/{accountId}</li><li>GET dataExtracts/userData</li></ul>  # noqa: E501

        :param linked_account_ids: The linked_account_ids of this DataExtractsAccount.  # noqa: E501
    ...
    def derived_apr(self):
        """Gets the derived_apr of this DataExtractsAccount.  # noqa: E501
        ...
        :return: The derived_apr of this DataExtractsAccount.  # noqa: E501
        :rtype: float
        """
    ...
    def derived_apr(self, derived_apr):
        ...
        :param derived_apr: The derived_apr of this DataExtractsAccount.  # noqa: E501
    ...
    @property
    def source_provider_account_id(self):
        """Gets the source_provider_account_id of this DataExtractsAccount.  # noqa: E501

        The providerAccountId that is deleted and merged into the destinationProviderAccountId as part of the many-to-one OAuth migration process.<br><b>Endpoints</b>:<ul><li>GET dataExtracts/userData</li></ul>  # noqa: E501

        :return: The source_provider_account_id of this DataExtractsAccount.  # noqa: E501
        :rtype: int
        """
        return self._source_provider_account_id

    @source_provider_account_id.setter
    def source_provider_account_id(self, source_provider_account_id):
        """Sets the source_provider_account_id of this DataExtractsAccount.

        The providerAccountId that is deleted and merged into the destinationProviderAccountId as part of the many-to-one OAuth migration process.<br><b>Endpoints</b>:<ul><li>GET dataExtracts/userData</li></ul>  # noqa: E501

        :param source_provider_account_id: The source_provider_account_id of this DataExtractsAccount.  # noqa: E501
        :type source_provider_account_id: int
        """

        self._source_provider_account_id = source_provider_account_id
