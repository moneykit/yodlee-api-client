...
class LoginForm(object):
    ...
    def __init__(self, mfa_info_title=None, help=None, forget_password_url=None, form_type=None, mfa_info_text=None, login_help=None, mfa_timeout=None, id=None, row=None, _configuration=None):  # noqa: E501
    ...
    def form_type(self, form_type):
        ...
        if (self._configuration.client_side_validation and
                form_type not in allowed_values):
            raise ValueError(
