...
class EnrichedTransaction(object):
    ...
    def __init__(self, container=None, source_id=None, merchant_city=None, high_level_category_id=None, detail_category_id=None, type=None, merchant_state=None, transaction_id=None, merchant_name=None, merchant_id=None, simple_description=None, sub_type=None, merchant_country=None, category_id=None, _configuration=None):  # noqa: E501
