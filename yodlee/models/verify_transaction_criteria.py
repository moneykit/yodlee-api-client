...
class VerifyTransactionCriteria(object):
    ...
    def __init__(self, _date=None, amount=None, verified_transaction=None, matched=None, keyword=None, date_variance=None, base_type=None, _configuration=None):  # noqa: E501
