...
class PaymentAccountBalance(object):
    ...
    def __init__(self, account_status=None, last_updated=None, account_name=None, account_type=None, current_balance=None, id=None, available_balance=None, local_vars_configuration=None):  # noqa: E501
        """PaymentAccountBalance - a model defined in OpenAPI"""  # noqa: E501
    ...
    def account_status(self):
        """Gets the account_status of this PaymentAccountBalance.  # noqa: E501
        ...
        :return: The account_status of this PaymentAccountBalance.  # noqa: E501
        :rtype: str
        """
    ...
    def account_status(self, account_status):
        """Sets the account_status of this PaymentAccountBalance.

        The status of the account that is updated by the user through an application or an API.</li><ul><li><b>ACTIVE:</b> All the added aggregated accounts status will be made \"ACTIVE\" by default.</li><li><b>TO_BE_CLOSED:</b> If the aggregated accounts are not found or closed in the data provider site, Yodlee system marks the status as TO_BE_CLOSED.</li><li><b>INACTIVE:</b> Users can update the status as INACTIVE to stop updating and to stop considering the account in other services.</li><li><b>CLOSED:</b> Users can update the status as CLOSED, if the account is closed with the provider.</li></ul><b>Endpoints</b>:<ul><li>GET /partner/paymentProcessor/account</li><li>GET /partner/paymentProcessor/account/balance</li><li>GET /partner/paymentProcessor/account/holder</li></ul>  # noqa: E501

        :param account_status: The account_status of this PaymentAccountBalance.  # noqa: E501
    ...
    def last_updated(self):
        """Gets the last_updated of this PaymentAccountBalance.  # noqa: E501
        ...
        :return: The last_updated of this PaymentAccountBalance.  # noqa: E501
        :rtype: str
        """
    ...
    def last_updated(self, last_updated):
        """Sets the last_updated of this PaymentAccountBalance.

        The date time the account information was last retrieved from the provider site and updated in the Yodlee system.<br><b>Endpoints</b>:<ul><li>GET /partner/paymentProcessor/account</li><li>GET /partner/paymentProcessor/account/balance</li><li>GET /partner/paymentProcessor/account/holder</li></ul>  # noqa: E501

        :param last_updated: The last_updated of this PaymentAccountBalance.  # noqa: E501
    ...
    def account_name(self):
        """Gets the account_name of this PaymentAccountBalance.  # noqa: E501
        ...
        :return: The account_name of this PaymentAccountBalance.  # noqa: E501
        :rtype: str
        """
    ...
    def account_name(self, account_name):
        """Sets the account_name of this PaymentAccountBalance.

        The account name as it appears at the site.<br><b>Endpoints</b>:<ul><li>GET /partner/paymentProcessor/account</li><li>GET /partner/paymentProcessor/account/balance</li><li>GET /partner/paymentProcessor/account/holder</li></ul>  # noqa: E501

        :param account_name: The account_name of this PaymentAccountBalance.  # noqa: E501
    ...
    def account_type(self):
        """Gets the account_type of this PaymentAccountBalance.  # noqa: E501
        ...
        :return: The account_type of this PaymentAccountBalance.  # noqa: E501
        :rtype: str
        """
    ...
    def account_type(self, account_type):
        """Sets the account_type of this PaymentAccountBalance.

        The type of account that is aggregated, i.e., savings, checking, charge, etc. The account type is derived based on the attributes of the account. <br><b>Endpoints</b>:<ul><li>GET /partner/paymentProcessor/account</li><li>GET /partner/paymentProcessor/account/balance</li><li>GET /partner/paymentProcessor/account/holder</li></ul>  # noqa: E501

        :param account_type: The account_type of this PaymentAccountBalance.  # noqa: E501
    ...
    def current_balance(self):
        """Gets the current_balance of this PaymentAccountBalance.  # noqa: E501


        :return: The current_balance of this PaymentAccountBalance.  # noqa: E501
        :rtype: Money
        """
    ...
    def current_balance(self, current_balance):
        """Sets the current_balance of this PaymentAccountBalance.


        :param current_balance: The current_balance of this PaymentAccountBalance.  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this PaymentAccountBalance.  # noqa: E501
        ...
        :return: The id of this PaymentAccountBalance.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this PaymentAccountBalance.

        The primary key of the account resource and the unique identifier for the account.<br><br><b>Endpoints</b>:<ul><li>GET /partner/paymentProcessor/account</li><li>GET /partner/paymentProcessor/account/balance</li><li>GET /partner/paymentProcessor/account/holder</li></ul>  # noqa: E501

        :param id: The id of this PaymentAccountBalance.  # noqa: E501
        :type id: int
        """
    ...
    def available_balance(self):
        """Gets the available_balance of this PaymentAccountBalance.  # noqa: E501


        :return: The available_balance of this PaymentAccountBalance.  # noqa: E501
        :rtype: Money
        """
    ...
    def available_balance(self, available_balance):
        """Sets the available_balance of this PaymentAccountBalance.


        :param available_balance: The available_balance of this PaymentAccountBalance.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaymentAccountBalance):
            return False
