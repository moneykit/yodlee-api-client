...
class TransactionCategorizationRuleInfo(object):
    ...
    def __init__(self, rule_clause=None, source=None, priority=None, category_id=None, _configuration=None):  # noqa: E501
    ...
    def rule_clause(self, rule_clause):
        ...
        """
        if self._configuration.client_side_validation and rule_clause is None:
