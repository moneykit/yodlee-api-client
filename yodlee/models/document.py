...
class Document(object):
    ...
    def __init__(self, account_id=None, last_updated=None, form_type=None, doc_type=None, name=None, id=None, source=None, status=None, _configuration=None):  # noqa: E501
    ...
    def doc_type(self, doc_type):
        ...
        if (self._configuration.client_side_validation and
                doc_type not in allowed_values):
            raise ValueError(
