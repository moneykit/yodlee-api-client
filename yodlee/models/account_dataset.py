...
class AccountDataset(object):
    ...
    def __init__(self, last_updated=None, update_eligibility=None, additional_status=None, next_update_scheduled=None, name=None, last_update_attempt=None, local_vars_configuration=None):  # noqa: E501
        """AccountDataset - a model defined in OpenAPI"""  # noqa: E501
    ...
    def update_eligibility(self, update_eligibility):
        ...
        if self.local_vars_configuration.client_side_validation and update_eligibility not in allowed_values:  # noqa: E501
            raise ValueError(
