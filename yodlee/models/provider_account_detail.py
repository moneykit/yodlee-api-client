...
class ProviderAccountDetail(object):
    ...
    def __init__(self, preferences=None, oauth_migration_status=None, is_manual=None, last_updated=None, consent_id=None, login_form=None, created_date=None, aggregation_source=None, provider_id=None, request_id=None, id=None, dataset=None, status=None, _configuration=None):  # noqa: E501
