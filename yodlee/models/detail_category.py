...
class DetailCategory(object):
    ...
    def __init__(self, name=None, id=None, local_vars_configuration=None):  # noqa: E501
        """DetailCategory - a model defined in OpenAPI"""  # noqa: E501
    ...
    def name(self):
        ...
        The name of the detail category<br><br><b>Applicable containers</b>: creditCard, investment, insurance, loan<br>  # noqa: E501
    ...
    def id(self):
        ...
        The unique identifier of the detail category.<br><br><b>Applicable containers</b>: creditCard, investment, insurance, loan<br>  # noqa: E501
