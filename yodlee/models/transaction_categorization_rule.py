...
class TransactionCategorizationRule(object):
    ...
    def __init__(self, rule_clauses=None, user_defined_rule_id=None, category_level_id=None, transaction_categorisation_id=None, mem_id=None, rule_priority=None, local_vars_configuration=None):  # noqa: E501
        """TransactionCategorizationRule - a model defined in OpenAPI"""  # noqa: E501
