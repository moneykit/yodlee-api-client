...
class TransactionCategory(object):
    ...
    def __init__(self, high_level_category_name=None, default_high_level_category_name=None, high_level_category_id=None, detail_category=None, id=None, source=None, category=None, classification=None, type=None, default_category_name=None, _configuration=None):  # noqa: E501
