...
class VerifyAccountRequest(object):
    ...
    def __init__(self, container=None, account_id=None, transaction_criteria=None, _configuration=None):  # noqa: E501
    ...
    def transaction_criteria(self, transaction_criteria):
        ...
        """
        if self._configuration.client_side_validation and transaction_criteria is None:
