...
class VerificationAccount(object):
    ...
    def __init__(self, account_name=None, account_type=None, account_number=None, bank_transfer_code=None, _configuration=None):  # noqa: E501
    ...
    def bank_transfer_code(self, bank_transfer_code):
        ...
        """
        if self._configuration.client_side_validation and bank_transfer_code is None:
