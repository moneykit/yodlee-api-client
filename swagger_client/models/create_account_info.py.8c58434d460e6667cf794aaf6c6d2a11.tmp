...
class CreateAccountInfo(object):
    ...
    def __init__(self, include_in_net_worth=None, address=None, account_name=None, account_type=None, due_date=None, memo=None, home_value=None, account_number=None, frequency=None, amount_due=None, balance=None, nickname=None, valuation_type=None, _configuration=None):  # noqa: E501
