...
class Verification(object):
    ...
    def __init__(self, account_id=None, reason=None, verification_status=None, provider_account_id=None, verification_type=None, account=None, verification_date=None, verification_id=None, _configuration=None):  # noqa: E501
