...
class Cobrand(object):
    ...
    def __init__(self, cobrand_login=None, cobrand_password=None, locale=None, _configuration=None):  # noqa: E501
    ...
    def cobrand_login(self, cobrand_login):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and cobrand_login is None:
    ...
    def cobrand_password(self, cobrand_password):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and cobrand_password is None:
