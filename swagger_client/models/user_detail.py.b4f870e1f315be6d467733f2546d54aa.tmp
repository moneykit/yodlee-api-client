...
class UserDetail(object):
    ...
    def __init__(self, preferences=None, address=None, login_name=None, name=None, id=None, role_type=None, email=None, segment_name=None, _configuration=None):  # noqa: E501
