...
class RewardBalance(object):
    ...
    def __init__(self, expiry_date=None, balance_to_reward=None, balance_type=None, balance=None, description=None, balance_to_level=None, units=None, _configuration=None):  # noqa: E501
